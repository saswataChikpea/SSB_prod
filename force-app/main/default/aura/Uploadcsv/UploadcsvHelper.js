({
    ...
    CreateAccount : function (component,jsonstr){
        ...
        if(UsageJSONdata.length > 0){
            for(var i=0 ; i<UsageJSONdata.length; i++){                            
                if(UsageJSONdata[i].Billable == 'TRUE'){
                    UsageJSONdata[i].Billable = true;
                }else{
                    UsageJSONdata[i].Billable = false;
                }                
            }            
    ...
    successmessage : function (){
        ...
        resultsToast.setParams({
            "title": "Usage stagingd Inserted Demo",
            "message": "Usage stagingd Inserted Succesfully",
            "type" : "success"                    
            //alert("Usage stagingd Inserted Succesfully");  */                   
        });                
        resultsToast.fire();
    ...
    serverSideCall : function(component,jsonstr) {
