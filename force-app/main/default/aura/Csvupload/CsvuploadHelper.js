({
    ...
    convertArrayOfObjectsToCSV : function(component,objectRecords){
        ...
        debugger 
        keys = ['Project_Name__c','Phase_Name__c','Name','Role__c','Actual_Hours__c','Date__c'];
        
        var Columnkeys = ['Project','Phase','Resource','Role','Actualhours','UploadDate'];
    ...
    keys = ['Project__r.Id','Project__r.Name','Id','Name','Resources__r.Id','Resources__r.name'];
    csvStringResult = '';
    csvStringResult += ['Project__r.Id','Project__r.Name','Id','Name','Resources__r.Id','Resources__r.name'];
    //csvStringResult += keys.join(columnDivider);
    csvStringResult += lineDivider;
